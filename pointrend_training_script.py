...
def set_config(train_means, train_stds):    
    ...
    cfg.merge_from_file("./pointrend_rcnn_R_50_FPN_3x_coco.yaml")
    ...
    cfg.OUTPUT_DIR = './pointrend_output'
...
def run_inference(cfg, val_tree_dicts):
    ...
    evaluator = COCOEvaluator("tree_val", cfg, False, output_dir="./pointrend_output/")
...
if __name__ == "__main__":
    with open('./pointrend_config.yaml','r') as f:
